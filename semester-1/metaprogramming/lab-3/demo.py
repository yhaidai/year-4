...
def sample_class_demo(py2sql):
    ...
    sc1.associated_object_attr.set_object_attr = {'new', 'value'}
    ...
    # py2sql.delete_class(SampleClass, cascade=True)
...
def demo(clear_db=True):
    ...
    # db_info_demo(py2sql, 'tensorflow$python$keras$engine$sequential$Sequential')
